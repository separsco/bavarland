  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_20rem] xl:items-start">
        ...
        <section className="flex flex-col rounded-[1.75rem] bg-sky px-5 py-6 text-center sm:p-6">
          <MediaSlot
            label="major-academy-promo-illustration"
            className="mx-auto h-40 w-full max-w-[220px] rounded-3xl bg-white/50"
          />
